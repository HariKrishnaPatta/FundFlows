...
const { Option } = Select;
const R2CSurplusFundsTransfer = ({firstName, lastName}) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "https://api.p360.build:6060/v1/fundflow/r2cSurplusFundsTransfer/fetchAll", { headers });
...
export default R2CSurplusFundsTransfer;